...
import ProductScreen from './CenturionLegionFunBattles/CenturionLegionScreens/ProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://sharp-core-max.site/`;
  const URL_IDENTIFAIRE = `IzVrpH3Q`;
  ...
  OneSignal.initialize('fa2b17e6-09ce-4059-8afd-aa5d050f3760');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-06T08:08:00'); //дата з якої поч працювати webView
